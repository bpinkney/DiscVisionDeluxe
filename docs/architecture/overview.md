...
## What It Does
DiscVisionDeluxe simulates disc golf flight. A real throw can be captured via a FLIR camera + AprilTag disc marker, or throw parameters can be entered manually through a UI panel. Either way, the DfisX physics engine simulates the full flight and visualizes it in Unity.
...
|---|---|---|
| DiscVisualizer | Assets/DiscVisionDeluxe/ | Owns the disc GameObject; drives DiscFlightSimulator; handles Rigidbody handoff |
