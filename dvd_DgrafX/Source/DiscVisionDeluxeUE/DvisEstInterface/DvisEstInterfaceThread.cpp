...
DvisEstInterfaceThread::DvisEstInterfaceThread(int32 InTargetCount)
{
...
uint32 DvisEstInterfaceThread::Run()
{
  bStopThread = false;
...
void DvisEstInterfaceThread::Exit()
{
  // Here's where we can do any cleanup we want to 
}


void DvisEstInterfaceThread::Stop()
{
...
bool DvisEstInterfaceThread::IsComplete() const
{
