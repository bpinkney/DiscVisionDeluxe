...
int main(int argc, char** argv )
{
  ...
  const cv::String keys =
    ...
    "{setgroundplane sgp |false| Sample AprilTag on the ground, and determine resulting ground plane}"
    ;
  ...
  // TODO: we should be calling reverse-order thread join/destroy functions here

  // this blocks prints, d'oh
  /*do 
  {
